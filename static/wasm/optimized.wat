(module
 ...
 (func $assembly/index/initData (param $0 i32) (param $1 i32) (param $2 i32)
  ...
  i32.store offset=52
  global.get $~lib/memory/__stack_pointer
  i32.const 1920027648
  call $~lib/rt/__newArray
  local.tee $15
  i32.store offset=56
  global.get $~lib/memory/__stack_pointer
  i32.const 1920029728
  call $~lib/rt/__newArray
  local.tee $16
  i32.store offset=60
  global.get $~lib/memory/__stack_pointer
  ...
  i32.store offset=64
  global.get $~lib/memory/__stack_pointer
  i32.const 1920033888
  call $~lib/rt/__newArray
  local.tee $18
  i32.store offset=68
  global.get $~lib/memory/__stack_pointer
  i32.const 1920035968
  call $~lib/rt/__newArray
  local.tee $19
  i32.store offset=72
  global.get $~lib/memory/__stack_pointer
  i32.const 1920038048
  call $~lib/rt/__newArray
  local.tee $20
  i32.store offset=76
  global.get $~lib/memory/__stack_pointer
  i32.const 1920040128
  call $~lib/rt/__newArray
  local.tee $21
  i32.store offset=80
  global.get $~lib/memory/__stack_pointer
