(module
 ...
 (global $~lib/rt/__rtti_base i32 (i32.const 85248))
 (memory $0 2)
 (data (i32.const 1036) ",")
 ...
 (data (i32.const 1436) "<")
 (data (i32.const 1452) " \00\00\00UUUUUU\d5?\89A`\e5\d0\"\d3?\bc\96\90\0fz6\cb?U0*\a9\13\d0\d0?")
 (data (i32.const 1500) "<")
 ...
 (data (i32.const 1612) "<")
 (data (i32.const 1628) " \00\00\00UUUUUU\d5?b\10X9\b4\c8\e2?\a5,C\1c\eb\e2\e6?\19\04V\0e-\b2\e5?")
 (data (i32.const 1676) "<")
 (data (i32.const 1692) " \00\00\00UUUUUU\d5?\c9v\be\9f\1a/\bd?]m\c5\fe\b2{\b2?\cd;N\d1\91\\\ae?")
 (data (i32.const 1740) "|")
 ...
 (func $~lib/staticarray/StaticArray<~lib/typedarray/Uint32Array>#constructor (param $0 i32) (result i32)
  (local $1 i32)
  local.get $0
  i32.const 268435455
  i32.gt_u
 ...
 (func $start:assembly/index
  ...
  i32.const 201
  call $~lib/staticarray/StaticArray<~lib/typedarray/Uint32Array>#constructor
   ...
   if
    ...
    loop $for-loop|18
     ...
     if
      ...
      i32.gt_s
      if (result f64)
       block $__inlined_func$assembly/index/lerp_clamped9 (result f64)
        f64.const 255
        local.get $0
        f64.convert_i32_s
        f64.const 1
        ...
        f64.const 255
        f64.gt
        br_if $__inlined_func$assembly/index/lerp_clamped9
        drop
        f64.const 0
        local.get $3
        f64.const 0
 ...
 (func $assembly/index/colorBalance (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $assembly/index/process (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (param $5 i32) (param $6 i32) (param $7 i32) (param $8 i32) (param $9 i32) (param $10 i32) (param $11 i32)
  local.get $0
  if
   local.get $3
   local.get $4
 ...
 (func $assembly/index/colorChange (param $0 i32) (param $1 i32)
  nop
 )
